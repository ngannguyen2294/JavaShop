...
/**
 * LanguageStrings4 generated by hbm2java
 */
public class LanguageStrings4  implements java.io.Serializable {
    ...
    public LanguageStrings4() {
    }

	
    public LanguageStrings4(int lsId) {
        this.lsId = lsId;
    }
    public LanguageStrings4(int lsId, Serializable lsFrontBack, Serializable lsName, Serializable lsValue, Serializable lsDescription, Float lsVersionAdded, Serializable lsDefaultValue) {
       this.lsId = lsId;
