...
/**
 * LanguageStrings5 generated by hbm2java
 */
public class LanguageStrings5  implements java.io.Serializable {
    ...
    public LanguageStrings5() {
    }

	
    public LanguageStrings5(int lsId) {
        this.lsId = lsId;
    }
    public LanguageStrings5(int lsId, Serializable lsFrontBack, Serializable lsName, Serializable lsValue, Serializable lsDescription, Float lsVersionAdded, Serializable lsDefaultValue) {
       this.lsId = lsId;
