...
/**
 * LanguageStrings1 generated by hbm2java
 */
public class LanguageStrings1  implements java.io.Serializable {
    ...
    public LanguageStrings1() {
    }

	
    public LanguageStrings1(int lsId) {
        this.lsId = lsId;
    }
    public LanguageStrings1(int lsId, Serializable lsFrontBack, Serializable lsName, Serializable lsValue, Serializable lsDescription, Float lsVersionAdded, Serializable lsDefaultValue) {
       this.lsId = lsId;
